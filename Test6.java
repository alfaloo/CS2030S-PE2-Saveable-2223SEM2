...
public class Test6 {
    public static void main(String[] args) {
        ...
        we.expect("Streaming.decode", Streaming.decode(pairLst1.stream()).equals(intList1), true);
        we.expect("Streaming.decode", Streaming.decode(pairLst2.stream()).equals(intList2), true);
        we.expect("Streaming.decode", Streaming.decode(pairLst3.stream()).equals(strList1), true);
        we.expect("Streaming.decode", Streaming.decode(pairLst4.stream()).equals(strList2), true);

        we.expect("Streaming.decode", Streaming.decode(pairLst1.stream()).equals(intList2), false);
        we.expect("Streaming.decode", Streaming.decode(pairLst2.stream()).equals(intList1), false);
        we.expect("Streaming.decode", Streaming.decode(pairLst3.stream()).equals(strList2), false);
        we.expect("Streaming.decode", Streaming.decode(pairLst4.stream()).equals(strList1), false);
    }
}
